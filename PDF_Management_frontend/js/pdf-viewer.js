    ...
    document.querySelectorAll('.reply-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            replyFormContainer.querySelector('form').addEventListener('submit', function(e) {
                ...
                const commenterName = this.querySelector('.reply-name').value.trim();
                
                if (!content || !commenterName) {
                    showError('Please provide both your name and reply');
                    return;
                }
                ...
                this.querySelector('.reply-name').value = '';
            });
        });
    });
}
...
function submitReply(parentId, content) {
    // Get the commenter name from the reply form
    const replyForm = document.querySelector(`.reply-form[data-parent-id="${parentId}"]`);
    const commenterName = replyForm.querySelector('.reply-name').value.trim();
